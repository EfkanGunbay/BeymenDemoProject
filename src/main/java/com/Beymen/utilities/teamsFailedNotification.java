...
public class teamsFailedNotification {
    ...
    private static final String WEBHOOK_URL = "https://sh3argos.webhook.office.com/webhookb2/cb18577c-235d-4c79-9c9e-6a0d75f0c0b5@e475bd9d-951d-42f8-ba0c-1c929af85c12/IncomingWebhook/fe00973d30574188b768bf8493b05dc5/dca477f9-11e3-4101-a592-9c4bc62291ca/V2jjLGX1ydoV8-rjMk19PzKOAESnfjVI4hFvnBpk5lPUM1";

    public void failedNotification() throws Exception {
        int fail = Integer.parseInt(getCucumberReportStatuses().get(5));
        if (fail == 0) {
            return;
        }
    ...
    private String createReport() {
        ...
        int fail = 0;
        try {
            fail = Integer.parseInt(getCucumberReportStatuses().get(5));
            if (fail != 0){
